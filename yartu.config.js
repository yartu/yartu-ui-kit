  ...
  theme: {
    extend: {
      ...
      width: {
        ...
        '1/2-gap-4': 'calc(49.99% - 0.5rem)',
        '1/2-gap-6': 'calc(49.99% - 0.75rem)',
        '1/4-gap-3': 'calc(24.99% - 0.75rem)',
        '1/3-gap-3': 'calc(32.99% - 0.75rem)',
        '1/3-gap-4': 'calc(32.99% - 0.5rem)',
        '3/5-gap-4': 'calc(59.99% - 0.5rem)',
        '2/5-gap-4': 'calc(39.99% - 0.5rem)',
        '1/3-gap-8': 'calc(32.99% - 1rem)',
        '2/3-gap-8': 'calc(66.99% - 1rem)',
        46: '11.25rem',
        60: '3.75rem',
      },
      fontSize: {
