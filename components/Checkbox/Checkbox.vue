...
const checkboxClass = computed(() => {
  return [
    ...
    {
      'bg-GREY-2': props.bg,
      'checked:bg-RED checked:hover:bg-RED-3 checked:disabled:!bg-RED-3 checked:disabled:opacity-50 indeterminate:bg-RED indeterminate:hover:bg-RED-3 indeterminate:disabled:opacity-50 indeterminate:disabled:hover:opacity-50':
        props.error && !props.color,
      'checked:bg-BLUE checked:hover:bg-HOVER-BLUE checked:disabled:!bg-LIGHTBLUE-3 indeterminate:bg-BLUE indeterminate:hover:bg-HOVER-BLUE indeterminate:disabled:bg-GREY-2 indeterminate:disabled:hover:bg-GREY-2':
