<template>
  <div class="relative">
    <div ref="target" :class="inputContainerClass">
      ...
      <slot v-if="!inline" name="activator" :open="open" :value="showDateWithFormat">
        <label
    ...
    <transition v-if="!bottomSheetController" name="fade">
        ...
        <div ref="pickerContainer" v-show="showPicker" :class="pickerClass">
          <div v-if="preset" class="flex flex-col gap-2 mb-4">
            <p class="text-sm text-GREY-1 font-semibold pb-1">
              <slot name="presetTitle"> PRESET </slot>
            </p>
            <div class="flex items-center gap-2">
              ...
              >
                <p class="text-sm text-BLACK-2 font-semibold">
                  <slot name="tomorrowTitle"> Tomorrow </slot>
                </p>
              ...
              >
                <p class="text-sm text-BLACK-2 font-semibold">
                  <slot name="2dayAfterTitle"> 2 days after </slot>
                </p>
                <p class="text-sm text-GREY-1">
            ...
            <div class="flex items-center gap-2">
              ...
              >
                <p class="text-sm text-BLACK-2 font-semibold">
                  <slot name="4dayAfterTitle"> 4 days after </slot>
                </p>
                <p class="text-sm text-GREY-1">
              ...
              >
                <p class="text-sm text-BLACK-2 font-semibold">
                  <slot name="1WeekAfterTitle"> 1 week after </slot>
                </p>
                <p class="text-sm text-GREY-1">
          ...
          <div v-if="!inline && buttons" class="w-full flex flex-wrap gap-3 justify-end">
            <button @click="clear" class="border border-BORDER rounded-lg px-2 py-1 hover:bg-GREY-3 h-fit">
              <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M7 7L17 17" stroke="#9AA1B4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                <path d="M7 17L17 7" stroke="#9AA1B4" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
              </svg>
            </button>
            <button
          ...
          <div ref="pickerContainer" :class="bottomSheetPickerClass">
            <div v-if="preset" class="flex flex-col gap-2 mb-4">
              ...
              <div class="flex items-center gap-2">
                ...
                >
                  <p class="text-sm text-BLACK-2 font-semibold">
                    <slot name="2dayAfterTitle"> 2 Day After </slot>
                  </p>
                  <p class="text-sm text-GREY-1">
                    {{ presetList.twoDayAfter.format('DD MMM HH:mm') }}
                  </p>
              ...
              <div class="flex items-center gap-2">
                ...
                >
                  <p class="text-sm text-BLACK-2 font-semibold">
                    <slot name="4dayAfterTitle"> 4 Day After </slot>
                  </p>
                  <p class="text-sm text-GREY-1">
                    {{ presetList.fourDayAfter.format('DD MMM HH:mm') }}
                  </p>
...
const now = props.modelValue && !isNaN(props.modelValue.$D) ? dayjs(props.modelValue, props.formatDate) : dayjs();
